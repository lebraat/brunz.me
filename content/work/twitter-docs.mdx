...
![IA planning — wireframes and sitemap sketches covering the war room glass wall at Twitter HQ](/work/twitter-docs/designblog-1.png)
...
![User research synthesis — whiteboard capturing developer pain points and priorities](/work/twitter-docs/designblog-2.png)
...
![The redesigned docs homepage — new sidebar navigation, API-based organization, and landing pages](/work/twitter-docs/designblog-6.png)

![Interactive API explorer — sample tweets with live request/response previews](/work/twitter-docs/designblog-4.png)

![The new developer support hub — organized by API with clear entry points](/work/twitter-docs/designblog-7.png)
